...
<main id="primary" class="site-main">
  <section id="fpHeading" class="has-hidden-images">
    ...
    <div class="content__wrapper max-w--large">
      ...
      <div class="flex__wrapper wysiwyg__reset">
        ...
        <div>
          <img height="<?php echo $headingImage['height']; ?>" src="<?php echo esc_url($headingImage['url']); ?>"
            alt="<?php echo esc_attr($headingImage['alt']); ?>" loading="lazy" class="staggered" />
        </div>
  ...
  <section id="companyInfo" class="has-hidden-images">
    <div class="content__wrapper max-w--large align-left">
      <div class="grid__wrapper">
        <div></div>
        <div class="content__wrapper">

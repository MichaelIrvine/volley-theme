          ...
          if (have_rows('case_study_content')) :
            while (have_rows('case_study_content')) : the_row();
              ...
              elseif (get_row_layout() == 'left_aligned_image_and_text_qWidth') :
                ...
                get_template_part('template-parts/case', 'study-left-aligned-image-text-quarter');
              ...
              elseif (get_row_layout() == 'image_and_text_right_qWidth') :
                ...
                get_template_part('template-parts/case', 'study-right-aligned-image-text-quarter');
